...
;    write_tiff,out_directory+datetime+'TOA_DH-CLOUD.tiff',dh_TOA_ref_angle,planarconfig=2,compression=1,/float;,GEOTIFF=GEOTIFF
    ...
    dhpoint_Data0047=dh_Data0047[dhpoint_pos_col-1:dhpoint_pos_col+1,dhpoint_pos_line-1:dhpoint_pos_line+1]
    dhpoint_NotNaN_pos=WHERE(FINITE(dhpoint_Data0047),count_notnan)
