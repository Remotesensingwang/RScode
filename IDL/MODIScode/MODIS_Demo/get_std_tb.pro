...
;*****************************************************
function get_std_TB, banddata, filter_h, filter_w
  ...
  ids_invalid = where(im le 0, count_ids_invalid)
  IF count_ids_invalid GT 0 THEN im[ids_invalid] = !values.F_NAN ;invalid_value
