...
;  input_directory3='H:\00data\MODIS\MODIS_L1data\2021'
  ...
  input_directory1='H:\00data\MODIS\DCC\DCC_L1data\2019'
  input_directory2='H:\00data\MODIS\DCC\DCC_L1data\2020'
  
  dir_list_hdf=[[input_directory1],[input_directory2]]
  dir_n_hdf=n_elements(dir_list_hdf)
  for dir_i_hdf=0,dir_n_hdf-1 do begin
    starttime=systime(1)
    modis_calculate_toa_DCC,input_directory=dir_list_hdf[dir_i_hdf]
