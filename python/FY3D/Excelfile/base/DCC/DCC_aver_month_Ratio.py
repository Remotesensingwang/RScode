...
# **************************************
# DCC fy3d和modis文件月均值匹配，并计算比率
# **************************************


input_modis_file=r'H:\00data\TOA\DCC\MODIS\407\data\base\dcc_base_modis_month.xlsx'
input_fy3d_file=r'H:\00data\TOA\DCC\FY3D\407\data\base\dcc_base_fy3d_month.xlsx'
output_file=r'H:\00data\TOA\DCC\01month\aver_month_base_dcc.xlsx'
fyband =['F_B1', 'F_B2', 'F_B3', 'F_B4', 'F_B5', 'F_B6', 'F_B7', 'F_B8', 'F_B16', 'F_B17', 'F_B18']
modisband=['M_B3', 'M_B4', 'M_B1', 'M_B2', 'M_B26', 'M_B6', 'M_B7', 'M_B8', 'M_B17', 'M_B18', 'M_B19']
newlist=[]
