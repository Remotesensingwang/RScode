...
# input_file=r'H:\00data\TOA\FY3D\removecloud\fycloudpro\1kmstd\315(20km-5)\dh_dingbiao2019_fy3d10km_6.xlsx'
...
df_base=df_base_1[(df_base_1['FY_B1_STD']<0.010) & (df_base_1['FY_B2_STD']<0.010) & (df_base_1['FY_B3_STD']<0.010) & (df_base_1['FY_B4_STD']<0.010)]

# df_base=df_base_1[(df_base_1['MOIS_B1_STD']<0.013) & (df_base_1['MODIS_B2_STD']<0.013) & (df_base_1['MODIS_B3_STD']<0.013) & (df_base_1['MODIS_B4_STD']<0.013)]
# df_base=df_base_1[(df_base_1['MOIS_B1_STD']<0.010) & (df_base_1['MODIS_B2_STD']<0.010) & (df_base_1['MODIS_B3_STD']<0.010) & (df_base_1['MODIS_B4_STD']<0.010)]
...
with pd.ExcelWriter(input_file, mode='a', engine='openpyxl') as writer:
        df_base.to_excel(writer, sheet_name="2q+stdlt0.01",index=False,header = True)
print('111')
